        ...
        <Collapse size="small">
          <Panel header="🖼️ Image URLs" key="images">
            <div style={{ fontSize: '12px' }}>
              ...
              <p style={{ marginTop: '10px' }}><strong>Fallback URLs:</strong></p>
          ...
          <Panel header="🏷️ Status" key="status">
            <div style={{ fontSize: '12px' }}>
              <p>
                <strong>Is Spam:</strong>{' '}
                <Tag color={nft.isSpam ? 'red' : 'green'}>
                  {nft.isSpam ? 'Yes' : 'No'}
                </Tag>
              </p>
              <p>
                <strong>Is Verified:</strong>{' '}
                <Tag color={nft.isVerified ? 'blue' : 'default'}>
                  {nft.isVerified ? 'Yes' : 'No'}
                </Tag>
              </p>
              <p><strong>Last Sync:</strong> {nft.lastSync || 'Unknown'}</p>
            </div>
          </Panel>
